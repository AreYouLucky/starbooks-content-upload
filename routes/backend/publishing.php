...
Route::middleware(['auth', 'stii_admin'])->group(function () {
    ...
    Route::get('/publishing-requests', [PublishedRequestController::class, 'publishingRequests']);
    ...
    Route::post('/publish-request/{id}', [PublishedRequestController::class, 'publishRequest']);
});
